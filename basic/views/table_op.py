...
@csrf_exempt
def delete_view(request, *args, **kwargs): # this method is used for deleting the entry from the databse using object id
    try:
...
@csrf_exempt
def get_entry_view(request, *args, **kwargs): # this method returns specific entry using the object id from database
    try:
